...
public abstract class DataRenderer extends Renderer {
    ...
    public static ChartAnimator getmAnimator() {
        return mAnimator;
    }
     ...
     */
    protected static ChartAnimator mAnimator;
    ...
    public void drawValue(Canvas c, ValueFormatter formatter, float value, Entry entry, int dataSetIndex, float x, float y, int color, String sec) {
        mValuePaint.setColor(color);
