...
package com.seeweekend.code.charting.components;
...
public class Legend extends ComponentBase {
    ...
    public void setPosition(LegendPosition newValue) {
     ...
     boolean isinside  = newValue == LegendPosition.LEFT_OF_CHART_INSIDE
                || newValue == LegendPosition.RIGHT_OF_CHART_INSIDE;
        setDrawInside(isinside);
    }
