...
public abstract class Utils {
    ...
    public static void drawXAxisValue(Canvas c, String text, float x, float y,
                                      Paint paint,
                                      PointF anchor, float angleDegrees, float bottms) {
        bottm = bottms;
        drawXAxisValue(c, text, x, y, paint, anchor, angleDegrees);
    }

    public static float bottm = 0.f;
    ...
    public static void drawXAxisValue(Canvas c, String text, float x, float y,
       ...
       // paint.setTextSize(15);
        if (angleDegrees != 0.f) {
            ...
            drawOffsetY += y;
            if (bottm != 0) {
                           drawOffsetY = drawOffsetY + bottm + 15;
            }
            c.drawText(text, drawOffsetX, drawOffsetY, paint);
        }
